CREATE SCHEMA IF NOT EXISTS 'ton-service' DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;

CREATE TABLE IF NOT EXISTS 'ton-service'.'prices' (
...
CREATE TABLE IF NOT EXISTS 'ton-service'.'product_type_examples' (
...
CREATE TABLE IF NOT EXISTS 'ton-service'.'product_types' (
  'PRODUCT_TYPE_ID' INT(11) NOT NULL,
